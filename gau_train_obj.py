...
from utils.loss_utils import l1_loss, ssim, msssim, loss_cls_3d
        ...
        for batch_data in training_dataloader:
            ...
            for batch_idx in range(batch_size):
                ...
                if iteration % opt.reg3d_interval == 0:
                    ...
                    logits3d = classifier(gaussians._objects_dc.permute(2,0,1)) # gaussians._objects_dc: [num_gaussian, 1, 16], permute -> [16, num_gaussian, 1], classifier -> [256, 63659, 1]
                    prob_obj3d = torch.softmax(logits3d,dim=0).squeeze().permute(1,0) # [num_gaussian, 256]
            ...
            with torch.no_grad():
                ...
                if (iteration in testing_iterations):
                    if test_psnr >= best_psnr:
                        ...
                        torch.save(classifier.state_dict(), os.path.join(scene.model_path, f"chkpnt_best_classifier.pth"))
                        
                if (iteration in saving_iterations):
                    print("\n[ITER {}] Saving Gaussians".format(iteration))
                    scene.save(iteration)
                    torch.save(classifier.state_dict(), os.path.join(scene.model_path, f"chkpnt_{iteration}_classifier.pth"))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--chkpnt_path", type=str, default="")
